<template lang="html">
  <div class="bigbox clear">
    <div class="shopList-left">
      <img alt="老磁器口豆汁店(方庄店)" class="logo-logo_3S1eSkn_0"
           src="https://fuss10.elemecdn.com/b/5e/242af7a377cacb38298b4f3bc5bb1jpeg.jpeg?imageMogr/format/webp/thumbnail/!130x130r/gravity/Center/crop/130x130/">
    </div>
    <div class="shopList-right">
      ...
      <div class="">
        ...
        <span>4.9</span>
        <span>月售1558单</span>
        <div content="蜂鸟专送" alt="蜂鸟专送" class="delivery-icon-hollow_3q8_B5r_0">
          蜂鸟专送
        </div>
      </div>
    </div>
